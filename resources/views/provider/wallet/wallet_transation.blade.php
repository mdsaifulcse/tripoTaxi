                ...
                <div class="manage-doc-section pad50">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control payment_mode" autocomplete="off" name="payment_mode" onchange="card(this.value);">
                            ...
                            <div class="input-group full-input">
                                <input type="number" class="form-control" required name="amount" placeholder="@lang('user.enter_amount')" >
                            </div>
...
<script>
    $('#submit-button').on('click', function(){
        var vall = $('.payment_mode').val();

        if(vall == "SSL"){
            $('#add_money').attr('action' , "{{ url('/provider/add/money/ssl') }}");
        }
        $('#add_money').submit();       
    });
var request=0; 
