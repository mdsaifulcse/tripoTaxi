                        ...
                        <div class="form-group row">
                            <div class="col-xs-4 arabic_right">
                                <label for="stripe_secret_key" class="col-form-label">
                                    @lang('admin.payment.ssl_payments')
                                </label>
                            </div>
                            <div class="col-xs-5">
                                <input @if(config('constants.ssl') == 1) checked  @endif autocomplete="off" name="ssl" id="ssl_check" type="checkbox" class="js-switch" data-color="#43b968">
                            </div>
                            <div class="col-xs-3 payumoney_icon">
                                <img class="pull-right " src="{{asset('asset/img/ssl.png')}}">
                            </div>
                        </div>
                        <div class="payment_settings" @if(config('constants.ssl') == 0) style="display: none;" @endif>
                            <div class="form-group row">
                                <label for="ssl_environment" class="col-xs-4 col-form-label">@lang('admin.payment.ssl_environment')</label>
                                <div class="col-xs-8">
                                    <select name="ssl_environment" class="form-control" required>
                                    <option @if(config('constants.ssl_environment') == "test") selected @endif value="test">Development</option>
                                    <option @if(config('constants.ssl_environment') == "secure") selected @endif value="secure">Production</option>
                                </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="ssl_store_id" class="col-xs-4 col-form-label">@lang('admin.payment.ssl_store_id')</label>
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="{{ config('constants.ssl_store_id') }}" name="ssl_store_id" id="ssl_store_id"  placeholder="@lang('admin.payment.stripe_secret_key')">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="ssl_store_pass" class="col-xs-4 col-form-label">@lang('admin.payment.ssl_store_pass')</label>
                                <div class="col-xs-8">
                                    <input class="form-control" type="text" value="{{ config('constants.ssl_store_pass') }}" name="ssl_store_pass" id="ssl_store_pass"  placeholder="@lang('admin.payment.ssl_store_pass')">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="ssl_currency" class="col-xs-4 col-form-label">@lang('admin.payment.currency')</label>
                                <div class="col-xs-8">
                                    <select name="ssl_currency" class="form-control" required>
                                    <option @if(config('constants.ssl_currency') == "USD") selected @endif value="USD">USD</option>
                                    <option @if(config('constants.ssl_currency') == "BDT") selected @endif value="BDT">BDT</option>
                                </select>
                                </div>
                            </div>
                        </div>
