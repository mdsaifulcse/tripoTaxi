...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">{{ $request->provider_service->service_type->name }}</dd>

                        <dt class="col-sm-4">Service Base Price :</dt>
                        <dd class="col-sm-8">{{ currency($request->provider_service->service_type->price) }}</dd>
            ...
            <br>
            <h4>Smart Taxi Details</h4>
                <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        <dt class="col-sm-4">Name :</dt>
                        <dd class="col-sm-8">{{ $request->name ? $request->name : '-' }}</dd>

                        <dt class="col-sm-4">Email :</dt>
                        <dd class="col-sm-8">{{ $request->email ? $request->email : '-' }}</dd>

                        <dt class="col-sm-4">Phone :</dt>
                        <dd class="col-sm-8">{{ $request->phone ? $request->phone : '-' }}</dd>

                        <dt class="col-sm-4">Address :</dt>
                        <dd class="col-sm-8">{{ $request->address ? $request->address : '-' }}</dd>

                        <dt class="col-sm-4">Document Type :</dt>
                        <dd class="col-sm-8">something</dd>

                        <dt class="col-sm-4">Others :</dt>
                        <dd class="col-sm-8">{{ $request->others ? $request->others : '-' }}</dd>
