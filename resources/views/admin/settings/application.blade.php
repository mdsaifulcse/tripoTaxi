					...
					<div class="col-xs-9">
						<select class="form-control" id="timezone" name="timezone" autocomplete="off">
						    @foreach($timezone as $zone)
							    <option value="{{ $zone }}" @if(Config::get('constants.timezone') == $zone) selected @endif>{{ $zone }}</option>
						    @endforeach
						</select>
					</div>
				</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-8">
                                <select name="currency" class="form-control" required>
                                    ...
                                    <option @if(config('constants.currency') == "MEX$") selected @endif value="MEX$"> Mexican Peso (MXN)</option>
                                </select>
                            </div>
                        </div>
