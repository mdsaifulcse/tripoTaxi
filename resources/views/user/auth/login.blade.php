        ...
        <div class="row no-margin">
            ...
            <div class="col-md-6 log-right">
                ...
                <div class="login-box row no-margin">
                    ...
                    {{ csrf_field() }}                      
                        {{-- <div class="col-md-12"> --}}
                             {{-- <input id="mobile" type="text" class="form-control" placeholder="Email Address" name="mobile" value="{{ old('mobile') }}" required autofocus>
                            ...
                            <div class="col-md-7">
                                <input type="text" autofocus id="mobile" class="form-control" placeholder="Enter Phone Number" name="mobile" value="{{ old('mobile') }}" data-stripe="number" maxlength="10" onkeypress="return isNumberKey(event);" />
                            </div>
                            <div class="col-md-7">
                                @if ($errors->has('mobile'))
                                    <span class="help-block">
