...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        try {
            ...
            return view('admin.dashboard', compact('providers', 'fleet', 'provider', 'scheduled_rides', 'users', 'rides', 'user_cancelled', 'provider_cancelled', 'cancel_rides', 'revenue', 'wallet'));
        } catch (Exception $e) {
    ...
    public function settings()
    {
        ...
        return view('admin.settings.application', compact('timezone'));
    }
    ...
    {
        try {
            $str = '{"content":"<p>We&#39;d like to thank you for deciding to use our script. We enjoyed creating it and hope you enjoy using it to achieve your goals :)&nbsp;If you want something changed to suit&nbsp;your venture&#39;s needs better, drop us a line: contact@aapbd.com<\/p>\r\n"}';
        ...
        try {
            ...
            foreach ($Providers as $index => $Provider) {
                ...
                $Providers[$index]->payment = UserRequestPayment::whereIn('request_id', $Rides)
                    ->select(\DB::raw(
                        'SUM(ROUND(provider_pay)) as overall, SUM(ROUND(commision)) as commission'
                    ))->get();
            }
    ...
    public function transferlist(Request $request)
    {
        ...
        if ($croute == 'admin.fleettransfer') {
            ...
            $totalList = Provider::get();
        }

        $pendinglist = $pendinglist->get();

        return view('admin.wallet.transfer', compact('pendinglist', 'type', 'totalList'));
    }
    ...
    {
        if (config('constants.demo_mode', 0) == 0) {
            $host = env('DB_HOST', '');
