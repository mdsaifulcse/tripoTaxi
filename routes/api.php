...
Route::post('otp-send','SmsApiController@otpSent');
Route::post('otp-verify','SmsApiController@verifyOtp');

Route::get('/settings' , 'UserApiController@settings');
Route::post('/verify' , 'UserApiController@verify');
Route::get('/verify-phone' , 'UserApiController@verifyPhone');
...
Route::group(['middleware' => ['auth:api']], function () {
	...
	Route::get('/payment/ssl', 'SslController@payment');
	Route::post('/add/money' , 	'PaymentController@add_money');
	Route::get('/add/money/ssl' , 	'SslController@add_money');
