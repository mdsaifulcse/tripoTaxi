...
Route::get('otp-send','UserApiController@otpSent');
Route::get('otp-verify','UserApiController@verifyOtp');
...
Route::post('/payment/ssl', 'SslController@payment');
...
Route::post('/add/money/ssl', 'SslController@add_money');
...
//wallet trsansfer success fail sslcommerz
Route::post('ssl/success', 'SslController@sslSuccess');
Route::post('ssl/fail', 'SslController@sslFail');